...
if __name__ == "__main__":
    ...
    for i in range(2):
        for j in range(2):
            ...
            plt.ylabel(f'number of reads')
            plt.savefig(f'{output_path}/plots_check/positions_{[contig.o for contig in contigs]}_0.png')
            plt.clf()
            ...
            plt.ylabel(f'number of reads')
            plt.savefig(f'{output_path}/plots_check/positions_{[contig.o for contig in contigs]}_1.png')
            plt.clf()
