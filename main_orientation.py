...
if __name__ == "__main__":
    ...
    with open(f"/lustre/groups/cbi/Users/aeliseev/aivanova/data/{min_contig_length_name}/stat.txt", "w") as file:
        pass
    ...
    for (j, chr_ind) in enumerate(chromosomes):
        ...
        with open(
                f"/lustre/groups/cbi/Users/aeliseev/aivanova/data/{min_contig_length_name}/final_chr{chr_ind}.layout.txt",
                "w") as file:
        ...
        with open(f"/lustre/groups/cbi/Users/aeliseev/aivanova/data/{min_contig_length_name}/stat.txt", "a") as file:
        ...
        plt.clf()
        plt.plot('iteration number', 'accuracy', accuracy_arr)
        plt.savefig(
            f'/lustre/groups/cbi/Users/aeliseev/aivanova/data/{min_contig_length_name}/plots/accuracy_chr{chr_ind}.png')

        plt.clf()
        plt.plot('iteration number', 'log_likelihood', log_likelihood_arr)
        plt.savefig(
            f'/lustre/groups/cbi/Users/aeliseev/aivanova/data/{min_contig_length_name}/plots/log_likelihood_chr{chr_ind}.png')
